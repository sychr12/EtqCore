...
function fillForm(data, refresh = true) { for (const [name, value] of Object.entries({ oc: '', ...data })) { const el = form.elements.namedItem(name); if (el) el.value = value ?? '' } if (refresh) updatePreview() }
